...
CREATE TABLE `Workman` (
    ...
    UNIQUE INDEX `Workman_email_key`(`email`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `WorkmanLocation` (
    `id` VARCHAR(191) NOT NULL,
    `longitude` DOUBLE NOT NULL,
    `latitude` DOUBLE NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `workmanId` VARCHAR(191) NOT NULL,

    UNIQUE INDEX `WorkmanLocation_workmanId_key`(`workmanId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- CreateTable
CREATE TABLE `WorkmanService` (
    `workmanId` VARCHAR(191) NOT NULL,
    `serviceId` VARCHAR(191) NOT NULL,

    PRIMARY KEY (`workmanId`, `serviceId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `WorkmanLocation` ADD CONSTRAINT `WorkmanLocation_workmanId_fkey` FOREIGN KEY (`workmanId`) REFERENCES `Workman`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `WorkmanService` ADD CONSTRAINT `WorkmanService_workmanId_fkey` FOREIGN KEY (`workmanId`) REFERENCES `Workman`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `WorkmanService` ADD CONSTRAINT `WorkmanService_serviceId_fkey` FOREIGN KEY (`serviceId`) REFERENCES `Service`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Work` ADD CONSTRAINT `Work_workmanId_fkey` FOREIGN KEY (`workmanId`) REFERENCES `Workman`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
